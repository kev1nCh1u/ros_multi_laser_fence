...
LaserscanMerger::LaserscanMerger()
{
    ...
    nh.param<std::string>("destination_frame", destination_frame, "base_link");
    nh.param<std::string>("cloud_destination_topic", cloud_destination_topic, "/merged_cloud");
    nh.param<std::string>("scan_destination_topic", scan_destination_topic, "/scan");
    nh.param<std::string>("laserscan_topics", laserscan_topics, "/scan_1 /scan_2");
